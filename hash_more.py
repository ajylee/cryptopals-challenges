# See:
#
# Pure Python 3.3 implementation:
# http://www.acooke.org/cute/PurePython0.html
#
# Pure Ruby implementation:
# http://rosettacode.org/wiki/SHA-1#Ruby
#
# C implementation (available python 2)
# https://docs.python.org/2/library/hashlib.html

# The following is adapted from acooke's implementation
#
# Changes:
# - Avoid `yield from`
# - Py2 izip_longest instead of Py3 zip_longest 
# - Format
...
SHA1 = make_md_hash_64(sha1_compress,
...
MD4 = make_md_hash_64(md4_compress,
